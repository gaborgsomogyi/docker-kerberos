...
public class Main {
  ...
  private static class MysqlJDBCConfiguration extends Configuration {
    private Configuration parent;
    Map<String, String> options = new HashMap<>();
    AppConfigurationEntry[] entry;

    public MysqlJDBCConfiguration(Configuration parent, String keytab, String principal) {
      this.parent = parent;
  ...
  public static void main(String[] args) throws SQLException, IOException {
    ...
    LOGGER.info("mysql-kerberos application started");

    if (args.length != 3) {
      System.out.println("Usage: mysql-kerberos <keytab> <principal> <url>");
      System.out.println("Example: mysql-kerberos share/mysql.keytab mysql/example.com@EXAMPLE.COM \"jdbc:mysql://example.com/mysql?user=mysql/example.com@EXAMPLE.COM");
      System.exit(1);
    }
    ...
    MysqlJDBCConfiguration config = new MysqlJDBCConfiguration(Configuration.getConfiguration(), args[0], args[1]);
