...
public class Main {
  ...
  private static class MssqlJDBCConfiguration extends Configuration {
    private Configuration parent;
    Map<String, String> options = new HashMap<>();
    AppConfigurationEntry[] entry;

    public MssqlJDBCConfiguration(Configuration parent, String keytab, String principal) {
      this.parent = parent;
  ...
  public static void main(String[] args) throws SQLException, IOException {
    ...
    LOGGER.info("mssql-kerberos application started");

    if (args.length != 3) {
      System.out.println("Usage: mssql-kerberos <keytab> <principal> <url>");
      System.out.println("Example: mssql-kerberos share/mssql.keytab mssql/example.com@EXAMPLE.COM \"jdbc:sqlserver://example.com;integratedSecurity=true;authenticationScheme=JavaKerberos;userName=mssql/example.com@EXAMPLE.COM");
      System.exit(1);
    }
    ...
    MssqlJDBCConfiguration config = new MssqlJDBCConfiguration(Configuration.getConfiguration(), args[0], args[1]);
